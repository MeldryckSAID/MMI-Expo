    ...
    <ul class="galery">
      ...
      <li v-for="item in video" :key="item.id">
        <video controls class="video">
          <source
            :src="item.video2.url"
            :type="getVideoType(item.video2.url)"
          />
          Votre navigateur ne supporte pas les vidéos HTML5.
        </video>
      </li>
      <li v-for="item in video" :key="item.id">
        <video controls class="video">
          <source
            :src="item.video3.url"
            :type="getVideoType(item.video3.url)"
          />
          Votre navigateur ne supporte pas les vidéos HTML5.
        </video>
      </li>
      <li v-for="item in video" :key="item.id">
        <video controls class="video">
          <source
            :src="item.video4.url"
            :type="getVideoType(item.video4.url)"
          />
          Votre navigateur ne supporte pas les vidéos HTML5.
        </video>
      </li>
      <li v-for="item in video" :key="item.id">
        <video controls class="video">
          <source
            :src="item.video5.url"
            :type="getVideoType(item.video5.url)"
          />
          Votre navigateur ne supporte pas les vidéos HTML5.
        </video>
      </li>
      <li v-for="item in video" :key="item.id">
        <video controls class="video">
          <source
            :src="item.video6.url"
            :type="getVideoType(item.video6.url)"
          />
          Votre navigateur ne supporte pas les vidéos HTML5.
        </video>
      </li>
      <li v-for="item in video" :key="item.id">
        <video controls class="video">
          <source
            :src="item.video7.url"
            :type="getVideoType(item.video7.url)"
          />
          Votre navigateur ne supporte pas les vidéos HTML5.
        </video>
      </li>
